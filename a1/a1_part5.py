...
def remove_red_in_image(image_data: list) -> list:
    ...
    """
    return [a1_part4.remove_red_in_row(colour) for colour in image_data]
...
def fade_red_in_image(image_data: list) -> list:
    ...
    - image_data is a non-empty list of colour rows, where each colour row has the same length
    """
    return [a1_part4.fade_red_in_row(colour) for colour in image_data]
...
def fade_rows_in_image(image_data: list) -> list:
    ...
    - image_data is a non-empty list of colour rows, where each colour row has the same length
    """
    return [a1_part4.fade_row(colour) for colour in image_data]
...
def blur_rows_in_image(image_data: list) -> list:
    ...
    """
    return [a1_part4.blur_row(colour) for colour in image_data]
...
def crop_rows_in_image(image_data: list, start: int, num_colours: int) -> list:
    ...
    """
    return [a1_part4.crop_row(colour, start, num_colours) for colour in image_data]
...
def crop_image(image_data: list, start_row: int, start_col: int, crop_height: int, crop_width: int) -> list:
    ...
    """
    num_cols = start_col + crop_width
    num_rows = start_row + crop_height
    return [[image_data[j][i] for i in range(start_col, num_cols)] for j in range(start_row, num_rows)]
