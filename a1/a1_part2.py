...
def format_name_and_number(given_name: str, family_name: str, phone_number: int) -> str:
    ...
    >>> format_name_and_number('LeBron', 'James', 4168722001)
    'JAMES, LeBron: 4168722001'
    """
    return family_name.upper() + ', ' + given_name + ': ' + str(phone_number)
...
def get_divisibility_dict(numbers: set, divisor: int) -> dict:
    ...
    True
    >>> get_divisibility_dict({10, 100, 34, 78}, 10) == {10: True, 100: True, 34: False, 78: False}
    True
    """
